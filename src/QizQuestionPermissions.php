...
use Drupal\quizzer\Entity\QizQuestion;


/**
 * Provides dynamic permissions for Qiz question of different types.
 *
 * @ingroup quizzer
 *
 */
class QizQuestionPermissions{
   ...
   *
   * @return array
   *   The QizQuestion by bundle permissions.
   *   @see \Drupal\user\PermissionHandlerInterface::getPermissions()
   */
  public function generatePermissions() {
    $perms = [];

    foreach (QizQuestionType::loadMultiple() as $type) {
   ...
   *
   * @param \Drupal\quizzer\Entity\QizQuestionType $type
   *   The QizQuestion type.
   *
   * @return array
   *   An associative array of permission names and descriptions.
   */
  protected function buildPermissions(QizQuestionType $type) {
    $type_id = $type->id();
