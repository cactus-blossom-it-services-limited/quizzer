...
use Drupal\quizzer\Entity\QizResultType;


/**
 * Provides dynamic permissions for Qiz result of different types.
 *
 * @ingroup quizzer
 *
 */
class QizResultPermissions{
   ...
   *
   * @return array
   *   The QizResult by bundle permissions.
   *   @see \Drupal\user\PermissionHandlerInterface::getPermissions()
   */
  public function generatePermissions() {
    $perms = [];

    foreach (QizResultType::loadMultiple() as $type) {
   ...
   *
   * @param \Drupal\quizzer\Entity\QizResultType $type
   *   The QizResult type.
   *
   * @return array
   *   An associative array of permission names and descriptions.
   */
  protected function buildPermissions(QizResultType $type) {
    $type_id = $type->id();
